...
//	velocity.addDy(1);
//	rocks.push_back(new MediumRock(getPoint(), getVelocity(), getAngle(),bottomRight,topLeft)); //medium 1
//
//	//ose should be 1 up the other 1 down
//	velocity.addDy(-2); //since we added 1 up we subtract 2 down now
//	rocks.push_back(new MediumRock(getPoint(), getVelocity(), getAngle(), bottomRight, topLeft)); //medium 2
//
//	velocity.addDy(1); //undo changes
//	velocity.addDx(2); //2 to the right
//	rocks.push_back(new SmallRock(getPoint(), getVelocity(), getAngle(), bottomRight, topLeft)); //small
//	
...
//	velocity.addDx(3);
//	rocks.push_back(new SmallRock(getPoint(), getVelocity(), getAngle(), bottomRight, topLeft)); //small 1
//
//																			
//	velocity.addDx(-6); //since we added 3 right we subtract -6 now, to go 3 left
//	rocks.push_back(new SmallRock(getPoint(), getVelocity(), getAngle(), bottomRight, topLeft)); //small 2
//
//	FlyingObject::kill(); //kill this bird
//}
