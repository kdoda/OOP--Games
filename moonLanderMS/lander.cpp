...
Lander::Lander()
{
  //called the default contsructor of point and velocity
	setFuel(500);
	setAlive(true);
	setLanded(false);
}
...
* LANDER :: CONSTRUCTOR
********************************************/
Lander::Lander(const Point &point, const Velocity &vel, int fuel, bool alive, bool landed)
...
Lander::Lander(const Point&point)
	: point(point)
{
   //called the default contsructor velocity
	setFuel(500);
	setAlive(true);
	setLanded(false);
}
